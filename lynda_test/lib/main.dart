...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Lynda.com from Samsung', storage: CounterStorage()),
    );
  }
}
...
class CounterStorage{
  //async is whenever app start it will sync 
  ...
  Future<int> readCounter() async{
    try {
      ...
      //if no data return 0 for counter
      return 0;
    }
  }
